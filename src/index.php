...
/**
 * 3. SOLUCIÓN URL GRAFANA
 * No usamos el puerto 3000. Usamos la ruta que configuramos en Nginx.
 */
...
<main class="p-6 md:p-10 max-w-7xl mx-auto space-y-8 animate-fade-in text-main">
    ...
    <header class="mb-8 border-b border-slate-200 dark:border-white/10 pb-5 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            ...
            <p class="text-[10px] text-muted uppercase tracking-[0.4em] mt-2 font-black opacity-80">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="<?= $grafanaUrl ?>" target="_blank" class="block group">
                    <div class="glass-panel p-6 rounded-3xl border border-slate-200 dark:border-white/5 bg-white/50 dark:bg-white/5 hover:bg-blue-50 dark:hover:bg-white/10 transition-all duration-300 shadow-xl">
                        ...
                        <h3 class="text-sm font-bold uppercase tracking-wider text-main">Métricas Grafana</h3>
                        <p class="text-xs text-muted mt-1">Telemetría segura vía CyberPyme Proxy.</p>
                    </div>
                </a>
        ...
        <aside class="space-y-6">
            <div class="glass-panel p-6 rounded-3xl border border-slate-200 dark:border-white/5 bg-white/50 dark:bg-white/5 shadow-2xl">
                <h3 class="text-xs font-black uppercase tracking-widest text-muted mb-6 italic">Diagnóstico de Salud</h3>
                <?= panelHealth($sysHealth) ?>
            </div>
            
            <div class="glass-panel p-6 rounded-3xl border border-slate-200 dark:border-white/5 bg-white/50 dark:bg-white/5 shadow-2xl">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xs font-black uppercase tracking-widest text-muted italic">Logs del Sistema</h3>
